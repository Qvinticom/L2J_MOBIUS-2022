 ...
 */
public class RecipeStatInstance
{
	...
	/**
	 * Constructor of RecipeStatInstance.
	 * @param type
	 * @param value
	 */
	public RecipeStatInstance(String type, int value)
	{
	...
	/**
	 * @return the the type of the RecipeStatInstance.
	 */
	...
	/**
	 * @return the value of the RecipeStatInstance.
	 */
	public int getValue()
	{
		return _value;
