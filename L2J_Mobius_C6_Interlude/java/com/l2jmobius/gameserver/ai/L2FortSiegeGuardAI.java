...
public class L2FortSiegeGuardAI extends L2CharacterAI implements Runnable
{
	...
	private boolean autoAttackCondition(L2Character target)
	{
		...
		if ((target == null) || (target instanceof L2FortSiegeGuardInstance) || (target instanceof L2FolkInstance) || (target instanceof L2DoorInstance) || target.isAlikeDead() || (target instanceof L2CommanderInstance) || (target instanceof L2Playable))
		{
