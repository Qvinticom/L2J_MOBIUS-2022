...
import com.l2jmobius.gameserver.network.serverpackets.OnVehicleCheckLocation;
...
{
	protected static final Logger LOGGER = Logger.getLogger(L2BoatInstance.class.getName());
