...
import com.l2jmobius.gameserver.model.PlayerStatus;
...
import com.l2jmobius.gameserver.network.serverpackets.TitleUpdate;
import com.l2jmobius.gameserver.network.serverpackets.TradePressOtherOk;
import com.l2jmobius.gameserver.network.serverpackets.TradePressOwnOk;
...
public final class L2PcInstance extends L2Playable
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2jmobius.gameserver.model.L2Character.AIAccessor#doCast(com.l2jmobius.gameserver.model.L2Skill)
		 */
		@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.actor.instance.L2PlayableInstance#getKnownList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.actor.instance.L2PlayableInstance#getStat()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.actor.instance.L2PlayableInstance#getStatus()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.L2Character#updatePvPFlag(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.L2Character#revalidateZone(boolean)
	 */
	@Override
	...
	public L2ItemInstance checkItemManipulation(int objectId, int count, String action)
	{
		...
		{
			LOGGER.warning(getObjectId() + ": player tried to " + action + " item not available in L2World");
			return null;
		}
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.L2Object#onActionShift(com.l2jmobius.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
		...
		// Like L2OFF set the target of the L2PcInstance player
		{
			...
			else
			{
				...
				if (isAutoAttackable(player))
				{
					...
					else // Calculate the distance between the L2PcInstance
					// Only archer can hit from long
					if ((currentWeapon != null) && (currentWeapon.getItemType() == L2WeaponType.BOW))
					{
						player.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK, this);
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.actor.instance.L2PlayableInstance#isInFunEvent()
	 */
	@Override
	...
	public void useMagic(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		/*
		 * if (isWearingFormalWear() && !skill.isPotion()) { sendPacket(SystemMessageId.CANNOT_USE_ITEMS_SKILLS_WITH_FORMALWEAR)); sendPacket(ActionFailed.STATIC_PACKET); abortCast(); return; }
		 */
		if (inObserverMode())
		{
		...
		// {
		// SystemMessage sm = SystemMessageId.SKILL_NOT_AVAILABLE);
	...
	public boolean checkPvpSkill(L2Object target, L2Skill skill, boolean srcIsSummon)
	{
		...
		if ((target != null) && // target not null and
			...
			!((L2PcInstance) target).isInsideZone(ZoneId.PVP) // target is not in PvP zone
		)
		{
			final SkillDat skilldat = getCurrentSkill();
	...
	public void leaveObserverMode()
	{
		if (!_observerMode)
		{
			...
			Util.handleIllegalPlayerAction(L2PcInstance.this, "Warning!! Character " + getName() + " tried to cheat in observer mode.", Config.DEFAULT_PUNISH);
		}
		setTarget(null);
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.L2Character#onTeleported()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.L2Character#updatePosition(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jmobius.gameserver.model.L2Character#reduceCurrentHp(double, com.l2jmobius.gameserver.model.L2Character)
	 */
	@Override
	...
	public synchronized void addBypass(String bypass)
	{
		...
		// LOGGER.warning("[BypassAdd]"+getName()+" '"+bypass+"'");
	}
	...
	public synchronized boolean validateBypass(String cmd)
	{
		...
		for (String bp : _validBypass)
		{
			...
			// LOGGER.warning("[BypassValidation]"+getName()+" '"+bp+"'");
			if (bp.equals(cmd))
			{
				return true;
			}
	...
	public synchronized boolean validateLink(String cmd)
	{
		...
		LOGGER.warning("[L2PcInstance] player [" + getName() + "] sent invalid link '" + cmd + "', ban this player!");
		return false;
	}
	...
	{
		if ((Rnd.get(100) <= Config.DEATH_PENALTY_CHANCE) && !(killer instanceof L2PcInstance) && !isGM() && (!getCharmOfLuck() || (!(killer instanceof L2GrandBossInstance) && !(killer instanceof L2RaidBossInstance))) && (!isInsideZone(ZoneId.PVP) && !isInsideZone(ZoneId.SIEGE)))
		{
