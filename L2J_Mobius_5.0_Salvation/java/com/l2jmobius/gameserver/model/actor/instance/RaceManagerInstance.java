...
public class RaceManagerInstance extends Npc
{
	...
	public RaceManagerInstance(NpcTemplate template)
	{
		...
		if (_notInitialized)
		{
			...
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.TICKET_SALES_FOR_THE_MONSTER_RACE_WILL_END_IN_S1_MIN), 2 * MINUTE, 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.TICKET_SALES_FOR_THE_MONSTER_RACE_WILL_END_IN_S1_MIN), 3 * MINUTE, 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.TICKET_SALES_FOR_THE_MONSTER_RACE_WILL_END_IN_S1_MIN), 4 * MINUTE, 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.TICKET_SALES_FOR_THE_MONSTER_RACE_WILL_END_IN_S1_MIN), 5 * MINUTE, 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.TICKET_SALES_FOR_THE_MONSTER_RACE_WILL_END_IN_S1_MIN), 6 * MINUTE, 10 * MINUTE);
			...
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.MONSTER_RACE_S2_WILL_BEGIN_IN_S1_MIN), 7 * MINUTE, 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.MONSTER_RACE_S2_WILL_BEGIN_IN_S1_MIN), 8 * MINUTE, 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.MONSTER_RACE_S1_WILL_BEGIN_IN_30_SEC), (8 * MINUTE) + (30 * SECOND), 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.MONSTER_RACE_S1_IS_ABOUT_TO_BEGIN_COUNTDOWN_IN_FIVE_SEC), (8 * MINUTE) + (50 * SECOND), 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.THE_RACE_WILL_BEGIN_IN_S1_SEC), (8 * MINUTE) + (55 * SECOND), 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.THE_RACE_WILL_BEGIN_IN_S1_SEC), (8 * MINUTE) + (56 * SECOND), 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.THE_RACE_WILL_BEGIN_IN_S1_SEC), (8 * MINUTE) + (57 * SECOND), 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.THE_RACE_WILL_BEGIN_IN_S1_SEC), (8 * MINUTE) + (58 * SECOND), 10 * MINUTE);
			ThreadPool.scheduleAtFixedRate(new Announcement(SystemMessageId.THE_RACE_WILL_BEGIN_IN_S1_SEC), (8 * MINUTE) + (59 * SECOND), 10 * MINUTE);
