...
Varka_One = [ 1350, 1351, 1353, 1354, 1355 ]
...
Varka_Two = [ 1357, 1358, 1360, 1361, 1362, 1369, 1370, ]
...
Varka_Three = [ 1364, 1365, 1366, 1368, 1371, 1372, 1373, 1374, 1375 ]
    #All Ketra Orc mobs
...
Chance = {
  ...
  1358:500,#Warrior
  1369:518,#Commander
  1370:604,#Elite guard
  1372:604,#Head guard
  1371:627,#Head magus
  1374:626,#Prophet Guard
  1375:626,#Disciple of Prophet
  1373:649#Prophet
}
...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st) :
   ...
   if event == "8371-03a.htm" :
       ...
       st.playSound("ItemSound.quest_middle")
   elif event == "8371-10-3.htm" :
       htmltext = "8371-10-3.htm"
       st.set("id","3")
       ...
       st.playSound("ItemSound.quest_middle")
   elif event == "8371-10-4.htm" :
       htmltext = "8371-10-4.htm"
       st.set("id","3")
       st.takeItems(Varka_Badge_Soldier, 300)
       ...
       st.playSound("ItemSound.quest_middle")
   elif event == "8371-11a.htm" :
       htmltext = "8371-11a.htm"
   elif event == "8371-19.htm" :
       htmltext = "8371-19.htm"
   elif event == "8371-11b.htm" :
       htmltext = "8371-11b.htm"
   elif event == "8371-20.htm" :
       htmltext = "8371-20.htm"
       st.takeItems(Varka_Badge_Soldier, -1)
       st.takeItems(Varka_Badge_Officer, -1)
       st.takeItems(Varka_Badge_Captain, -1)
       st.takeItems(Ketra_Alliance_One, -1)
 ...
 def onKill(self,npc,player,isPet):
   ...
   if st :
      if st.getState() == STARTED :
          ...
          if not player.isAlliedWithVarka() :
