...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,st):
   ...
   elif npcId == 7624 and st.getInt("step") == 1 :
      htmltext = "7624-07.htm"
   elif npcId == 7624 and st.getInt("step") == 2  and st.getQuestItemsCount(MASONS_LETTER_ID) :
      htmltext = "7624-09.htm"
   elif npcId == 7624 and st.getInt("step") == 2  and st.getQuestItemsCount(ASCALONS_LETTER2_ID) :
      htmltext = "7624-11.htm"
   elif npcId == 7624 and st.getInt("step") == 2 :
      htmltext = "7624-08.htm"
   elif npcId == 7624 and st.getInt("step") == 3 and st.getQuestItemsCount(WHITE_ROSE_INSIGNIA_ID) :
      htmltext = "7624-12.htm"
   elif npcId == 7624 and st.getInt("step") == 3 and st.getQuestItemsCount(GROOTS_LETTER_ID) :
      htmltext = "7624-13.htm"
   elif npcId == 7624 and st.getInt("step") == 3 and st.getQuestItemsCount(ASCALONS_LETTER3_ID) :
      htmltext = "7624-15.htm"
   elif npcId == 7624 and st.getInt("step") == 5 and st.getQuestItemsCount(MOUENS_LETTER_ID) :
   ...
   elif npcId == 7624 and st.getInt("step") in [4,5] :
      htmltext = "7624-16.htm"
   elif npcId == 7625 and st.getInt("step") == 1 and st.getQuestItemsCount(ASCALONS_LETTER1_ID) :
      htmltext = "7625-01.htm"
   elif npcId == 7625 and st.getInt("step") == 2 and st.getQuestItemsCount(BLOODY_AXE_HEAD_ID) < 100 :
      htmltext = "7625-04.htm"
   elif npcId == 7625 and st.getInt("step") == 2 and st.getQuestItemsCount(BLOODY_AXE_HEAD_ID) > 99 :
   ...
   elif npcId == 7625 and st.getInt("step") == 2 and st.getQuestItemsCount(MASONS_LETTER_ID) :
      htmltext = "7625-06.htm"
   elif npcId == 7625 and st.getInt("step") == 2 and (st.getQuestItemsCount(ASCALONS_LETTER2_ID) or st.getQuestItemsCount(WHITE_ROSE_INSIGNIA_ID) or st.getQuestItemsCount(ASCALONS_LETTER2_ID) or st.getQuestItemsCount(WHITE_ROSE_INSIGNIA_ID) or st.getQuestItemsCount(GROOTS_LETTER_ID) or st.getQuestItemsCount(ASCALONS_LETTER3_ID) or st.getQuestItemsCount(MOUENS_ORDER1_ID) or st.getQuestItemsCount(MOUENS_ORDER2_ID) or st.getQuestItemsCount(MOUENS_LETTER_ID) or st.getQuestItemsCount(GROOTS_LETTER_ID)) :
      htmltext = "7625-07.htm"
   elif npcId == 7093 and st.getInt("step") == 2 and st.getQuestItemsCount(ASCALONS_LETTER2_ID) :
      htmltext = "7093-01.htm"
   elif npcId == 7093 and st.getInt("step") == 3 and st.getQuestItemsCount(WHITE_ROSE_INSIGNIA_ID) and (st.getQuestItemsCount(HARPYS_EGG1_ID) < 30 or st.getQuestItemsCount(MEDUSA_VENOM1_ID) < 30 or st.getQuestItemsCount(WINDSUS_BILE1_ID)<30) :
      htmltext = "7093-03.htm"
   elif npcId == 7093 and st.getInt("step") == 3 and st.getQuestItemsCount(WHITE_ROSE_INSIGNIA_ID) and st.getQuestItemsCount(HARPYS_EGG1_ID) >= 30 and st.getQuestItemsCount(MEDUSA_VENOM1_ID) >= 30 and st.getQuestItemsCount(WINDSUS_BILE1_ID) >= 30 :
   ...
   elif npcId == 7093 and st.getInt("step") == 3 and st.getQuestItemsCount(GROOTS_LETTER_ID) :
      htmltext = "7093-05.htm"
   elif npcId == 7093 and st.getInt("step") == 3 and (st.getQuestItemsCount(ASCALONS_LETTER3_ID) or st.getQuestItemsCount(MOUENS_ORDER1_ID) or st.getQuestItemsCount(MOUENS_ORDER2_ID) or st.getQuestItemsCount(MOUENS_LETTER_ID)) :
      htmltext = "7093-06.htm"
   elif npcId == 7196 and st.getInt("step") == 3 and st.getQuestItemsCount(ASCALONS_LETTER3_ID) :
      htmltext = "7196-01.htm"
   elif npcId == 7196 and st.getInt("step") == 4 and st.getQuestItemsCount(MOUENS_ORDER1_ID) and st.getQuestItemsCount(ROAD_RATMAN_HEAD_ID) < 100 :
      htmltext = "7196-04.htm"
   elif npcId == 7196 and st.getInt("step") == 4 and st.getQuestItemsCount(MOUENS_ORDER1_ID) and st.getQuestItemsCount(ROAD_RATMAN_HEAD_ID) >= 100 :
      htmltext = "7196-05.htm"
   elif npcId == 7196 and st.getInt("step") == 5 and st.getQuestItemsCount(MOUENS_ORDER2_ID) and st.getQuestItemsCount(LETO_LIZARDMAN_FANG1_ID) < 100 :
   ...
   elif npcId == 7196 and st.getInt("step") == 5 and st.getQuestItemsCount(MOUENS_LETTER_ID) :
      htmltext = "7196-09.htm"
   return htmltext

 def onKill (self,npc,player,isPet):
   st = player.getQuestState("223_TestOfChampion")
   if st :
     if st.getState() != STARTED : return
     npcId = npc.getNpcId()
     step, maxcount, chance, itemid = DROPLIST[npcId]
     if st.getInt("step") == step and st.getQuestItemsCount(itemid) < maxcount and st.getRandom(100) < chance:
