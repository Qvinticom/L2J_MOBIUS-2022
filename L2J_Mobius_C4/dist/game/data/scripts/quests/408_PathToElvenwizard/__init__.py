...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st) :
    ...
    if event == "1" :
        ...
        if st.getPlayer().getClassId().getId() != 0x19 :
          ...
          if st.getInt("cond") != 0 and st.getQuestItemsCount(MAGICAL_POWERS_RUBY_ID) != 0 :
            htmltext = "7414-10.htm"
          elif st.getInt("cond") != 0 and st.getQuestItemsCount(MAGICAL_POWERS_RUBY_ID) == 0 and st.getQuestItemsCount(FERTILITY_PERIDOT_ID) != 0 :
            if st.getQuestItemsCount(ROGELLIAS_LETTER_ID) == 0 :
              st.giveItems(ROGELLIAS_LETTER_ID,1)
            htmltext = "7414-07.htm"
            st.set("cond","2")
    elif event == "408_4" :
          if st.getInt("cond") != 0 and st.getQuestItemsCount(ROGELLIAS_LETTER_ID) != 0 :
          ...
          if st.getInt("cond") != 0 and st.getQuestItemsCount(PURE_AQUAMARINE_ID) != 0 :
            htmltext = "7414-13.htm"
          elif st.getInt("cond") != 0 and st.getQuestItemsCount(PURE_AQUAMARINE_ID) == 0 and st.getQuestItemsCount(FERTILITY_PERIDOT_ID) != 0 :
            if st.getQuestItemsCount(APPETIZING_APPLE_ID) == 0 :
              st.giveItems(APPETIZING_APPLE_ID,1)
            htmltext = "7414-14.htm"
    elif event == "408_5" :
          if st.getInt("cond") != 0 and st.getQuestItemsCount(APPETIZING_APPLE_ID) != 0 :
          ...
          if st.getInt("cond") != 0 and st.getQuestItemsCount(NOBILITY_AMETHYST_ID) != 0 :
            htmltext = "7414-17.htm"
          elif st.getInt("cond") != 0 and st.getQuestItemsCount(NOBILITY_AMETHYST_ID) == 0 and st.getQuestItemsCount(FERTILITY_PERIDOT_ID) != 0 :
 ...
 def onTalk (Self,npc,st):
   ...
   elif npcId == 7414 and st.getInt("cond")!=0 and st.getQuestItemsCount(CHARM_OF_GRAIN_ID)!=0 and st.getQuestItemsCount(RED_DOWN_ID)<5 :
        htmltext = "7414-09.htm"
   elif npcId == 7414 and st.getInt("cond")!=0 and st.getQuestItemsCount(CHARM_OF_GRAIN_ID)!=0 and st.getQuestItemsCount(RED_DOWN_ID)>=5 :
        htmltext = "7414-25.htm"
   elif npcId == 7414 and st.getInt("cond")!=0 and st.getQuestItemsCount(APPETIZING_APPLE_ID)!=0 :
        htmltext = "7414-15.htm"
   elif npcId == 7371 and st.getInt("cond")!=0 and st.getQuestItemsCount(APPETIZING_APPLE_ID)!=0 :
        htmltext = "7371-01.htm"
   elif npcId == 7371 and st.getInt("cond")!=0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE_ID)!=0 and st.getQuestItemsCount(GOLD_LEAVES_ID)<5 :
   ...
   elif npcId == 7414 and st.getInt("cond")!=0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE_ID)!=0 and st.getQuestItemsCount(GOLD_LEAVES_ID)<5 :
        htmltext = "7414-16.htm"
   elif npcId == 7414 and st.getInt("cond")!=0 and st.getQuestItemsCount(CHARM_OF_GRAIN_ID)!=0 and st.getQuestItemsCount(GOLD_LEAVES_ID)>=5 :
        htmltext = "7414-26.htm"
   elif npcId == 7414 and st.getInt("cond")!=0 and st.getQuestItemsCount(IMMORTAL_LOVE_ID)!=0 :
        htmltext = "7414-19.htm"
   elif npcId == 7423 and st.getInt("cond")!=0 and st.getQuestItemsCount(IMMORTAL_LOVE_ID)!=0 :
   ...
   elif npcId == 7423 and st.getInt("cond")!=0 and st.getQuestItemsCount(LUCKY_POTPOURI_ID)!=0 and st.getQuestItemsCount(AMETHYST_ID)<2 :
   ...
   elif npcId == 7414 and st.getInt("cond")!=0 and st.getQuestItemsCount(LUCKY_POTPOURI_ID)!=0 and st.getQuestItemsCount(AMETHYST_ID)<2 :
 ...
 def onKill (self,npc,player,isPet):
   st = player.getQuestState("408_PathToElvenwizard")
   if st :
     if st.getState() != STARTED : return
     npcId = npc.getNpcId()
     if npcId == 466 :
        st.set("id","0")
        if st.getInt("cond") != 0 and st.getQuestItemsCount(CHARM_OF_GRAIN_ID) != 0 and st.getQuestItemsCount(RED_DOWN_ID)<5 and st.getRandom(100)<70 :
        ...
        st.set("id","0")
        if st.getInt("cond") != 0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE_ID) != 0 and st.getQuestItemsCount(GOLD_LEAVES_ID)<5 and st.getRandom(100)<40 :
        ...
        st.set("id","0")
        if st.getInt("cond") != 0 and st.getQuestItemsCount(LUCKY_POTPOURI_ID) != 0 and st.getQuestItemsCount(AMETHYST_ID)<2 and st.getRandom(100)<40 :
...
QUEST.addTalkId(7157)
QUEST.addTalkId(7371)
QUEST.addTalkId(7414)
QUEST.addTalkId(7423)
