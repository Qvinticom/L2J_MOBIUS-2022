...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,st):
   ...
   if id == CREATED :
     ...
     st.set("onlyone","0")
     st.set("id","0")
   if npcId == 7391 and st.getInt("cond")==0 :
      ...
      if st.getInt("cond")<15 :
        ...
        htmltext = "7391-04.htm"
   elif npcId == 7391 and st.getInt("cond")!=0 and (st.getQuestItemsCount(FLAME_EARING_ID)==0 or st.getQuestItemsCount(WIND_BANGEL_ID)==0 or st.getQuestItemsCount(WATER_NECKLACE_ID)==0 or st.getQuestItemsCount(EARTH_RING_ID)==0) :
      htmltext = "7391-05.htm"
   elif npcId == 7411 and st.getInt("cond")!=0 and st.getQuestItemsCount(MAP_OF_LUSTER_ID)==0 and st.getQuestItemsCount(FLAME_EARING_ID)==0 :
        ...
        st.set("cond","2")
   elif npcId == 7411 and st.getInt("cond")!=0 and st.getQuestItemsCount(MAP_OF_LUSTER_ID)!=0 and st.getQuestItemsCount(KEY_OF_FLAME_ID)==0 :
        ...
        st.set("cond","4")
   elif npcId == 7411 and st.getInt("cond")!=0 and st.getQuestItemsCount(FLAME_EARING_ID)!=0 :
        #Talking to the Flame Salamander
        #after finishing the Fire component results
        #in the following text
        htmltext = "7411-04.htm"
   elif npcId == 7412 and st.getInt("cond")!=0 and st.getQuestItemsCount(FLAME_EARING_ID)!=0 and st.getQuestItemsCount(BROKEN_BRONZE_MIRROR_ID)==0 and st.getQuestItemsCount(WIND_BANGEL_ID)==0 :
        ...
        st.set("cond","5")
   elif npcId == 7412 and st.getInt("cond")!=0 and st.getQuestItemsCount(BROKEN_BRONZE_MIRROR_ID)!=0 and st.getQuestItemsCount(WIND_FEATHER_ID)==0 :
        ...
        st.set("cond","7")
   elif npcId == 7412 and st.getInt("cond")!=0 and st.getQuestItemsCount(WIND_BANGEL_ID)!=0 :
        #Talking to the Wind Sylph after we get the WIND_BANGLE_ID
        #results in the following text
        htmltext = "7412-04.htm"
   elif npcId == 7410 and st.getInt("cond")!=0 and st.getQuestItemsCount(BROKEN_BRONZE_MIRROR_ID)!=0 and st.getQuestItemsCount(WIND_FEATHER_ID)==0 :
   ...
   elif npcId == 7413 and st.getInt("cond")!=0 and st.getQuestItemsCount(WIND_BANGEL_ID)!=0 and st.getQuestItemsCount(RAMAS_DIARY_ID)==0 and st.getQuestItemsCount(WATER_NECKLACE_ID)==0 :
        ...
        st.set("cond","8")
   elif npcId == 7413 and st.getInt("cond")!=0 and st.getQuestItemsCount(RAMAS_DIARY_ID)!=0 and st.getQuestItemsCount(SPARKLE_PEBBLE_ID)<2 :
        ...
        st.set("cond","10")
   elif npcId == 7413 and st.getInt("cond")!=0 and st.getQuestItemsCount(WATER_NECKLACE_ID)!=0 :
        #Talking to the Water Undine after completing it's task
        htmltext = "7413-04.htm"
   elif npcId == 7409 and st.getInt("cond")!=0 and st.getQuestItemsCount(WATER_NECKLACE_ID)!=0 and st.getQuestItemsCount(RUST_GOLD_COIN_ID)==0 and st.getQuestItemsCount(EARTH_RING_ID)==0 :
        ...
        st.set("cond","11")
   elif npcId == 7409 and st.getInt("cond")!=0 and st.getQuestItemsCount(RUST_GOLD_COIN_ID)!=0 and st.getQuestItemsCount(RED_SOIL_ID)==0 :
        ...
        st.set("cond","13")
   elif npcId == 7409 and st.getInt("cond")!=0 and st.getQuestItemsCount(EARTH_RING_ID)!=0 :
        #Talking to the Earth Snake after completing his task
        htmltext = "7409-03.htm"
   elif npcId == 7391 and st.getInt("cond")!=0 and st.getQuestItemsCount(FLAME_EARING_ID)!=0 and st.getQuestItemsCount(WIND_BANGEL_ID)!=0 and st.getQuestItemsCount(WATER_NECKLACE_ID)!=0 and st.getQuestItemsCount(EARTH_RING_ID)!=0 :
 ...
 def onKill (self,npc,player,isPet):
   st = player.getQuestState("404_PathToWizard")
   if st :
     ...
     if npcId == 359 :    #Ratman Warrior, as of C3.
        ...
        if st.getInt("cond") == 8 and st.getQuestItemsCount(SPARKLE_PEBBLE_ID) < 2:
...
QUEST.addTalkId(7391)
QUEST.addTalkId(7409)
QUEST.addTalkId(7410)
QUEST.addTalkId(7411)
QUEST.addTalkId(7412)
QUEST.addTalkId(7413)

QUEST.addKillId(21)
QUEST.addKillId(359)
QUEST.addKillId(5030)